...
<template>
  <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ eventName }}</th>
  ...
  <td class="px-4 py-3 flex items-center justify-end">
    ...
    <div :id="`${eventName}-dropdown-button`" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
